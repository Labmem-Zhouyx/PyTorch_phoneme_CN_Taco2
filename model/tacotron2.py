...
class Tacotron2(nn.Module):
    def __init__(self, hparams):
        ...
        self.speaker_classifier = AdversarialClassifier(encoder_out_dim, hparams.num_speakers, hparams.spk_classifier_hidden_dims)

        # Decoder
        encoder_out_dim = encoder_out_dim + hparams.speaker_embedding_dim
    ...
    def inference(self, inputs, speaker_ids):
        ...
        inputs = inputs, None, None, speaker_ids
